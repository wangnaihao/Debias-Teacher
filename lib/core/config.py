...
#weight
config.WEIGHT = edict()
config.WEIGHT.LOSS_POSE = 1
config.WEIGHT.LOSS_CONS = 0.7
config.WEIGHT.LOSS_MIX = 0.7
config.WEIGHT.LOSS_WORST = 0.7

#ema
config.USE_EMA = False

#co-register
config.USE_COREG = False
...
def get_model_name(cfg):
    ...
    if name in ['pose_resnet', 'pose_dual','pose_cons','pose_hrnet','pose_cons1']:
