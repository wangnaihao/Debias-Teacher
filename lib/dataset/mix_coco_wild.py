...
class Mixed_COCO_WILD_Dataset(JointsDataset):
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        if cfg.RAW_INPUT:
            self.ai = COCODataset(cfg, root, 'unlabeled', False, transform)
        else:
            self.ai = COCODataset(cfg, root, 'unlabeled', is_train, transform)
