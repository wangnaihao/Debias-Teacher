...
from core.function import train,cotrain
...
import wandb
wandb = wandb.init(
    project='cvpr2024-pose-project-cotrain1',
    config=args,
    name=args.name
    # resume = True,
)
...
def main():
    ...
    for epoch in range(begin_epoch, config.TRAIN.END_EPOCH):
        print("---------------Train Two Net------------------")
        cotrain(config, train_loader, model1,model2, criterion, optimizer1,optimizer2, epoch,
